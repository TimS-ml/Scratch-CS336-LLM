...
Usage:
    python -m scratch_cs336.serve.chat --model_path <path_to_model>

Example:
    python -m scratch_cs336.serve.chat --model_path outputs/ckpt/tiny_llm_sft_92m
"""
...
from scratch_cs336.core.generation import make_context, TextIterStreamer
