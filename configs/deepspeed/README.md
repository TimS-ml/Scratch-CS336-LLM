...
deepspeed: configs/deepspeed/zero2.json  # or zero3.json
...
cp configs/deepspeed/zero2.json configs/deepspeed/my_config.json

# Edit as needed / 根据需要编辑
nano configs/deepspeed/my_config.json
```
